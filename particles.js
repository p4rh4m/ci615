!function t(e, i, r) {
                ...
                return n(e, [{
                    ...
                    value: function() {
                        this.x = Math.random() * this.maxX,
                            ...
                            this.size = Math.random() * (t.size.max - t.size.min) + t.size.min,
                            this.speed = {
                    ...
                    value: function(e) {
                        this.x += this.speed.x,
                            this.y += this.speed.y,
                        (this.x < 0 || this.y < 0 || this.x > this.maxX || this.y > this.maxY) && this.reset(),
                            e.beginPath(),
    ...
    2: [function(t, e, i) {
        ...
        window.Particles = function() {
            function e(t, i) {
                for (var r in i)
                    "object" === o(t[r]) && "object" === o(i[r]) ? t[r] = e(t[r], i[r]) : t[r] = i[r];
                return t
            }
            ...
            return function() {
                function t(n, o) {
                    if (r(this, t),
                    !n || "canvas" !== n.tagName.toLowerCase())
                ...
                return n(t, [{
                    ...
                    value: function() {
                        ...
                        for (var e = this.target.offsetWidth * this.target.offsetHeight, r = Math.floor(e / (1 / this.options.density * 1e5) / 50), n = new Array, o = 0; o < r; o++)
                            n.push(new i(this.target.offsetWidth,this.target.offsetHeight));
